...
const CHILD_PAGE_ALIASES: IntentRule[] = [
  ...
  },
  {
    ...
    label: "ברכות מוקלטות",
    phrases: ["ברכות מוקלטות", "ברכה מוקלטת", "ברכות", "ברכה לחתונה"],
  },
  {
  ...
  },
  {
    ...
    label: "הפקת בר מצווה ובת מצווה",
    phrases: [
      "תקליטן לבר מצווה",
      "תקליטן לבר מצווה במודיעין",
      "dj לבת מצווה",
      "הפקת בר מצווה",
      "כמה עולה תקליטן לבר מצווה",
    ],
  },
  {
    href: "/shop#vouchers",
    label: "שובר מתנה לאולפן",
    phrases: [
      "שובר מתנה לאולפן",
      "שובר דיגיטלי לאולפן",
      "מתנה הקלטה באולפן",
  ...
  },
  {
    href: "/shop#used-gear",
    label: "ציוד יד שנייה",
    phrases: ["ציוד יד שנייה", "למכור ציוד הגברה", "קונטרולר למכירה"],
  },
  {
    href: "/events/attractions",
  ...
  },
  {
    ...
    phrases: [
      "סטודיו לפודקאסט",
      "אולפן פודקאסט במודיעין",
      "להקליט פודקאסט במודיעין",
    ],
  },
  {
    href: "/podcast/podcast-editing",
    label: "עריכת פודקאסט",
    phrases: ["עריכת פודקאסט", "לערוך פרק פודקאסט", "ניקוי הקלטת זום"],
  },
];
