...
export const STUDIO_SERVICES = {
  "studio-hub": {
    ...
    metaTitle: "אולפן הקלטות ופודקאסט במודיעין | הקלטה מבוססת חומרה",
    metaDescription:
  ...
  "recording-song-modiin": {
    ...
    metaTitle:
      "הקלטת שיר מקצועי במודיעין | קריינות אנושית - מסירה תוך 48 שעות",
    metaDescription:
...
export const EVENTS_SERVICES = {
  ...
  "events-dj": {
    ...
    metaTitle: "דיג׳יי לאירועים | מודיעין, שוהם, ירושלים וכל הארץ",
    metaDescription:
