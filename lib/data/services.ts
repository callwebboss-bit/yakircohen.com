...
export const STUDIO_SERVICES = {
  "studio-hub": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "ברכה קצרה מתחילה מ-350 ש\"ח. שיר מלא עם עריכה - מ-600 ש\"ח. לחבילות ולמחירון המלא ראו את עמוד המחירון - שקיפות מלאה, ללא הפתעות.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "מודיעין-מכבים-רעות - 15 דקות מירושלים, נגיש מהשפלה והמרכז. חניה חופשית בשפע ממש ליד האולפן.",
      },
    ],
    hubCard: null,
  ...
  "recording-song-modiin": {
    ...
    pricing: [
      ...
      },
      {
        ...
        price: "החל מ-590 ₪",
        description:
          "הקלטת ברכה, דרשה קצרה או אמירה. עד 30 דקות באולפן עם ליווי טכני מלא. ✓ כולל עריכת סאונד - ✓ כולל מע״מ",
      },
    ],
  ...
  "studio-mobile-studio": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "שולחים תאריך ומיקום בוואטסאפ. בדרך כלל מענה תוך שעה בשעות פעילות (א׳-ה׳). אחרי אישור - מגיעים כ-30 דקות לפני ההקלטה להקמת ציוד.",
      },
      {
        id: "room",
  ...
  "blessings-hub": {
    ...
    subtitle:
      "הקלטת ברכה באולפן במודיעין או מהבית. מוזיקת רקע, עריכת סאונד ומסירה מוכנה לאירוע - בדרך כלל תוך 24-48 שעות.",
    ...
    faqs: [
      {
        ...
        answer:
          "מחיר הקלטת ברכה מתחיל מ-350 שקל לברכה קצרה. דרשה ארוכה עם עריכה ומוזיקה: 500 עד 700 שקל. שיר ברכה מקורי מחיר בנפרד. שולחים הודעה ומקבלים הצעה מדויקת תוך שעות.",
      },
      {
        id: "what-to-record",
  ...
  "blessings-bride-groom": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "ברכה קצרה מתחילה מ-350 ₪ + מע״מ. מחיר סופי לפי אורך הטקסט, מוזיקת רקע ועריכה. רואים הצעה לפני שמתחייבים.",
      },
      {
