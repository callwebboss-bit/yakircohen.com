...
export const VIDEO_SERVICES = {
  ...
  "video-presentation": {
    ...
    metaDescription:
      "הפקת מצגות וידאו מקצועיות ומצגת גדילה ב-AI - ציר זמן מילדות עם אפקט גדילה. עריכה, אנימציה, סאונד ומיתוג לכנסים ואירועים.",
    keywords: [
      "מצגת וידאו",
      "מצגת גדילה",
      "קליפ גדילה AI",
  ...
  "video-photo-slideshow": {
    ...
    metaDescription:
      "הפקת מצגות תמונות מרגשות ומצגת גדילה ב-AI — ציר זמן מילדות עם אפקט גדילה. לחתונות, בר/בת מצווה, ימי הולדת. עריכה קולנועית ומסירה מוכנה להקרנה.",
    keywords: [
      "מצגת תמונות לאירוע",
      "מצגת גדילה",
      "קליפ גדילה AI",
