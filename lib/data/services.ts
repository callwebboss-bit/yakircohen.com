...
export const STUDIO_SERVICES = {
  "studio-hub": {
    ...
    slug: "studio",
    category: "studio",
    title: "האולפן שבנוי להקלטה נקייה - מהיסוד, עם חומרה אמיתית",
    subtitle:
    ...
    metaDescription:
      "אולפן הבנוי להקלטה נקייה עם רצפה צפה ובידוד אקוסטי מלא. שרשרת סאונד מבוססת חומרה הכוללת ממשקי UAD, מיקרופוני Townsend Sphere L22 וציוד Allen & Heath.",
    keywords: [
      "אולפן הקלטות",
      "סטודיו מודיעין",
      "הקלטת שיר",
...
export const EVENTS_SERVICES = {
  "events-hub": {
    ...
    slug: "events",
    category: "events",
    title: "DJ, הגברה ואטרקציות לאירועים - מודיעין, ירושלים והמרכז",
    subtitle:
  ...
  "events-dj": {
    ...
    metaTitle: "דיג׳יי לאירועים | מודיעין, שוהם, ירושלים וכל הארץ | יקיר כהן הפקות",
    metaDescription:
      "ניהול מוזיקלי ותקלוט בוטיק לאירועים בפריסה ארצית. שיטת עבודה מוגדרת למניעת טעויות ברחבה: ניהול אישי או פיקוח מלא על צוות תקליטנים מנוסה.",
    keywords: [
      "דיגגיי במודיעין",
      "דיגגיי בשוהם",
      "דיגגיי בירושלים",
  ...
  "events-attractions-hub": {
    ...
    subtitle:
      "מכונות עשן כבד, בועות וקונפטי לאירועים. ציוד מקצועי, תפעול מבוקר ותיאום מלא עם DJ ומנהל האירוע.",
