...
export const STUDIO_SERVICES = {
  "studio-hub": {
    ...
    metaDescription:
      "סטודיו הקלטות מקצועי במודיעין - שירים במתנה, ברכות חתן כלה, הקלטות שקטות, קליפים ומיקס ווקאלי מקצועי. שירות ללקוחות ממודיעין, ירושלים והמרכז.",
    keywords: [
      "אולפן הקלטות",
      "סטודיו מודיעין",
      "הקלטת שיר",
  ...
  "recording-song-modiin": {
    ...
    category: "studio",
    title: "הקלטת שירים באולפן מקצועי במודיעין",
    subtitle:
      "מהרעיון ועד לתוצר המוגמר  -  הפקה מוזיקלית מלאה עם ציוד פרימיום וטכנולוגיית AI מתקדמת. שיר לחתונה, שיר מתנה או פרויקט מוזיקלי  -  מלווים אתכם מהשנייה הראשונה.",
    metaTitle: "הקלטת שירים באולפן מקצועי במודיעין",
    metaDescription:
      "הקלטת שירים באולפן במודיעין  -  אפיון, פלייבק, הקלטה עם SM7B ו-SphereL22, עריכה ו-AI, מיקס ומאסטר. שיר לחתונה, מתנה ליום הולדת ופרויקטים מוזיקליים.",
    keywords: [
      "הקלטת שיר מודיעין",
      "אולפן הקלטות מודיעין",
      "שיר לחתונה",
    ...
    features: [
      "שיחת אפיון ותכנון לפני ההקלטה",
      "הכנת פלייבק או עיבוד מוזיקלי מלא",
      "הקלטה עם מיקרופוני SM7B / SphereL22 / EV RE20",
      "עריכה, תיקון זיופים ב-AI ומיקס מקצועי",
      "מסירה תוך 24-48 שעות ב-WAV ו-MP3",
    ],
    pricing: [
      {
        name: "הקלטת שיר (קאבר)",
        price: "החל מ-1,200 ₪",
        description:
          "הקלטה על פלייבק קיים + עריכה + מיקס. כולל מע״מ.",
      },
      {
        name: "שיר מתנה אישי",
        price: "החל מ-1,800 ₪",
    ...
    faqs: [
      {
        id: "experience",
        question: "אני לא זמר מקצועי  -  זו בעיה?",
        answer:
          "בכלל לא. טכנולוגיית ה-AI שלנו עוזרת לתקן זיופים תוך שמירה על הרגש והטבעיות. רוב הלקוחות מקליטים בפעם הראשונה  -  והתוצאות מדהימות.",
      },
      {
        id: "ideas",
        question: "האם יש רעיונות לשירים שאפשר להקליט?",
        answer:
          "בטח. ראו דוגמאות בעמוד זה, בדף הקליפ באולפן ובמרכז הברכות  -  או פנו אלינו בוואטסאפ ונציע כיוונים לפי סוג האירוע.",
      },
      {
        id: "duration",
        question: "כמה זמן לוקח להקליט שיר?",
        answer:
          "שיר פשוט (3-4 דקות) יכול להיות מוכן תוך שעה-שעתיים באולפן. פרויקטים מורכבים יותר יכולים לקחת 3-4 שעות.",
      },
      {
        id: "lyrics-only",
        question: "יש לי רק מילים ולחן  -  אתם עוזרים בעיבוד?",
        answer:
          "בהחלט. אנחנו יוצרים עיבוד מוזיקלי מלא  -  גיטרה, תופים, בס, קלידים  -  כל מה שצריך. זה נכנס בחבילת ההפקה המלאה.",
      },
      {
        id: "backing-vocals",
        question: "אפשר להוסיף זמר מקצועי לגיבויים?",
        answer:
          "כן. אנחנו עובדים עם זמרים וזמרות מקצועיים לקולות גיבוי או דואטים. העלות: 300-500 ₪ (תלוי בהיקף).",
      },
    ],
    hubCard: {
  ...
  "studio-jerusalem": {
    ...
    metaDescription:
      "אולפן הקלטות לתושבי ירושלים  -  נסיעה קצרה למודיעין, ליווי אישי, תוכן כשר, שירים לחופה, ברכות ודרשות. אפשרות לאולפן נייד עד ירושלים.",
    keywords: [
  ...
  "studio-mobile-studio": {
    ...
    metaDescription:
      "אולפן הקלטות נייד לכל הארץ  -  פנלים אקוסטיים, מיקרופונים מקצועיים ומפיק צמוד. שירים, קליפים וקבוצות גדולות בבית, בבית ספר או במשרד.",
    keywords: [
      "אולפן נייד",
      "אולפן הקלטות נייד",
      "הקלטת שיר בבית",
  ...
  "blessings-hub": {
    ...
    metaDescription:
      "הקלטת ברכות באולפן במודיעין או מהבית  -  דרשה, בר/בת מצווה, חתן וכלה, אירועים וימי הולדת. ליווי, עריכה, מוזיקת רקע ומיקס מקצועי.",
    keywords: [
      "הקלטת ברכה",
      "ברכות חתן כלה",
      "דרשה מוקלטת",
  ...
  "blessings-bar-mitzvah": {
    ...
    metaDescription:
      "הקלטת ברכות ודרשות לבר/בת מצווה - ניסוח מלווה, הקלטה שקטה, עריכה ומוזיקה. שירות מקצועי במודיעין לכל הארץ.",
  ...
  "blessings-bride-groom": {
    ...
    metaDescription:
      "הקלטת ברכת חתן וכלה באולפן במודיעין - ליווי בניסוח, הקלטה שקטה, מיקס ומוזיקה. מתנה משפחתית בלתי נשכחת.",
  ...
  "blessings-video-clip": {
    ...
    metaDescription:
      "הפקת קליפ שיר באולפן במודיעין - הקלטה, צילום, עריכת וידאו וסאונד. חבילה משולבת לשירי מתנה וברכות ויזואליות.",
...
export const VOICEOVER_SERVICES = {
  "voiceover-hub": {
    ...
    metaDescription:
      "קריינות מקצועית לפרסומות, סרטוני תדמית, IVR ומרכזיות - אולפן מתקדם, ליווי ביצוע והפקה מלאה. שירות למודיעין, המרכז וכל הארץ.",
    keywords: [
      "קריינות מקצועית",
      "קריינות לפרסומות",
      "הקלטת IVR",
  ...
  "voiceover-services": {
    ...
    metaDescription:
      "הקלטות קריינות לפרסומות, IVR, סרטוני הדרכה ותדמית - ביצוע מקצועי, עריכה מדויקת ומסירה מהירה לשימוש מיידי.",
    keywords: [
      "קריינות מסחרית",
      "קריינות IVR",
      "קריינות לסרטון",
  ...
  "voiceover-course": {
    ...
    metaDescription:
      "קורס קריינות פרונטלי במודיעין - סילבוס מקצועי, תרגול באולפן, משוב אישי והכנה לעבודה בשוק. פתיחת מחזורים לפי תיאום.",
    keywords: [
      "קורס קריינות",
      "לימודי קריינות",
      "אקדמיה לקריינות",
...
export const EVENTS_SERVICES = {
  "events-hub": {
    ...
    subtitle:
      "DJ מוביל, השכרת הגברה ותאורה, הנחיית אירועים ואטרקציות יוקרתיות - חבילות מותאמות לחתונות, אירועי חברה וחגיגות פרטיות ברמה הגבוהה ביותר.",
    metaTitle: "הפקות אירועים ואטרקציות במודיעין",
    metaDescription:
      "DJ לאירועים, ציוד הגברה ותאורה, מנחה מקצועי ואטרקציות מקצועי - שירות ממודיעין לכל הארץ. חתונות, בר/בת מצווה ואירועים עסקיים.",
    keywords: [
      "DJ לאירועים",
      "השכרת הגברה",
      "אטרקציות לחתונה",
    ...
    features: [
      ...
      "הנחיית אירועים וניהול לוז זמנים חלק",
      "אטרקציות יוקרתיות: עשן, בועות ותותחי קונפטי",
  ...
  "events-dj": {
    ...
    metaDescription:
      "תקליטן מקצועי לחתונות, בר/בת מצווה ואירועי חברה  -  ציוד פרימיום, קריאת קהל, חבילות עם אטרקציות. מודיעין והארץ.",
    keywords: [
      "תקליטן לאירועים",
      "DJ לחתונה",
      "DJ לאירועים",
    ...
    pricing: [
      {
        ...
        description: "DJ + ציוד הגברה + תאורה בסיסית.",
      },
      {
        name: "חבילת פרימיום ★",
        price: "הצעה בוואטסאפ",
        ...
        description:
          "DJ + ציוד מקצועי + תאורה מתקדמת + 2 אטרקציות לבחירה.",
      },
    ],
  ...
  "events-equipment": {
    ...
    metaDescription:
      "השכרת רמקולים והגברה  -  RCF 745, סאב 15, מיקסר Allen & Heath. הקמה ופירוק כלולים. מודיעין והסביבה. הצעת מחיר תוך 24 שעות.",
    keywords: [
      "השכרת הגברה",
      "השכרת רמקולים",
      "מערכת הגברה לאירוע",
  ...
  "events-singer-amplification": {
    ...
    metaTitle: "הגברה לזמרים | צ'ק סאונד מקצועי",
    metaDescription:
      "הגברה לזמרים ולהקות  -  חבילות 2,800-7,800 ₪. Shure, RCF, צ'ק סאונד 30-60 דקות, גיבוי מלא. מודיעין והארץ.",
    keywords: [
      "הגברה לזמרים",
      "הגברה להופעה",
      "צ'ק סאונד",
  ...
  "events-wedding-packages": {
    ...
    metaDescription:
      "חבילות חתונה ואירועים  -  DJ + 3 אטרקציות, חבילת פסטיבל ועוד. חיסכון 20-30%. בנו חבילה בוואטסאפ.",
    keywords: [
      "חבילות לחתונה",
      "חבילת DJ ואטרקציות",
      "חבילות אירועים",
  ...
  "events-host": {
    ...
    metaDescription:
      "שירותי הנחייה וניהול אירועים - חתונות, בר/בת מצווה ואירועי חברה. נוכחות בטוחה, הומור מדוד ודיוק מקצועי.",
    keywords: [
      "מנחה אירועים",
      "MC לחתונה",
      "ניהול אירועים",
    ...
    features: [
      ...
      "ניהול לוז, כניסות ומעברים בין חלקים",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "DJ מנגן ומנהל רחבה. מנחה מוביל את הטקסים, מתאם בין הספקים ומדבר עם הקהל. לאירועים עם חלקים מורכבים - טקס, ארוחה, נאומים, ריקודים - מנחה הוא הדבק שמחזיק הכל יחד.",
      },
      {
        id: "host-prep",
  ...
  "events-attractions-hub": {
    ...
    metaDescription:
      "אטרקציות מקצועי לחתונות ואירועים - מכונת עשן, בועות ותותח קונפטי עם הפעלה מקצועית ובטיחות מלאה.",
    keywords: [
      "אטרקציות לחתונה",
      "מכונת עשן לאירוע",
      "תותח קונפטי",
  ...
  "attractions-bubble-machine": {
    ...
    metaDescription:
      "בועות סבון לחתונה, בר מצווה ואירועים  -  עשן, LED, מפעיל צמוד, תיאום DJ וצלם. בטוח לילדים, לא מחליק, 1,800+ אירועים.",
    keywords: [
      "בועות סבון לאירוע",
      "מכונת בועות",
      "בועות עשן",
  ...
  "attractions-smoke-bubble-machine": {
    ...
    metaDescription:
      "השכרת מכונת בועות סבון עשן לחתונה, סלואו ובר מצווה  -  אפקט כפול, נוזל שלא מחליק, מפעיל צמוד ותיאום DJ. היט באירועים.",
    keywords: [
      "בועות סבון עשן",
      "מכונת בועות עשן",
      "בועות עשן לחתונה",
  ...
  "attractions-heavy-smoke-large": {
    ...
    metaDescription:
      "עשן כבד לאירועים גדולים  -  טכנולוגיית דחיפה כפולה, מפעיל צמוד, בטוח ויבש. אולמות ענק ואירועי חוץ. יקיר כהן הפקות.",
    keywords: [
  ...
  "attractions-wedding-smoke": {
    ...
    metaDescription:
      "עשן כבד מקצועי לסלואו, חופה ואירועים  -  ענן לבן בגובה הברך, תיאום DJ וצלם, בטיחות מלאה. מעל 1,800 אירועים בכל הארץ.",
    keywords: [
      "עשן כבד לחתונה",
      "עשן כבד לסלואו",
      "קרח יבש לאירוע",
  ...
  "attractions-confetti-cannon": {
    ...
    metaDescription:
      "קונפטי מקצועי לחתונה ואירועים  -  עד 30 מטר, צבעים מותאמים, מפעיל וגיבוי CO₂. בטוח באולם סגור. מעל 1,800 אירועים.",
    keywords: [
      "תותח קונפטי",
      "קונפטי לחתונה",
      "קונפטי לאירועים",
  ...
  "attractions-cold-fireworks": {
    ...
    metaDescription:
      "זיקוקים קרים לחתונה ובר מצווה  -  4 מכונות, מפעיל צמוד, תיאום DJ. בטוח באולמות סגורים, ללא עשן. מעל 1,800 אירועים.",
    keywords: [
      "זיקוקים קרים",
      "זיקוקים קרים לחתונה",
      "זיקוקים לחופה",
  ...
  "attractions-giant-balloons": {
    ...
    metaDescription:
      "השכרת בלוני ענק לרחבת ריקודים ואירועים - עיצוב מרשים, התקנה מקצועית ואפקט ויזואלי לכל גיל.",
  ...
  "attractions-led-booth": {
    ...
    metaDescription:
      "עמדת LED להשכרה  -  P3.91, 4,500 Nits, Resolume. חתונות, DJ, אירועי חברה. מודיעין והמרכז. מעל 1,800 אירועים.",
    keywords: [
      "עמדת LED",
      "עמדת DJ LED",
      "השכרת עמדת לד",
  ...
  "attractions-smoke-cannons": {
    ...
    metaDescription:
      "השכרת תותחי עשן לאירועים - אפקט דרמטי, הפעלה מקצועית וחבילות גמישות לפי מספר יריות וסוג האירוע.",
    keywords: [
      "תותחי עשן",
      "עשן לאירוע",
      "אטרקציית עשן",
...
export const VIDEO_SERVICES = {
  "video-hub": {
    ...
    metaDescription:
      "שירותי וידאו מקצועיים - צילום אירועים, סרטי תדמית, מצגות וידאו וליווי הפקה מלא. ממודיעין לכל הארץ.",
    keywords: [
      "הפקות וידאו",
      "צילום אירועים",
      "סרט תדמית",
  ...
  "video-event-filming": {
    ...
    metaDescription:
      "צילום והפקת וידאו לחתונות, אירועי חברה וחגיגות - עריכה מדויקת, סאונד נקי ומסירה מהירה לשיתוף.",
    keywords: [
      "צילום אירועים",
      "וידאו לחתונה",
      "הפקת וידאו לאירוע",
  ...
  "video-corporate": {
    ...
    metaDescription:
      "הפקת סרטי תדמית לעסקים - אפיון מסר, צילום, עריכה וגרסאות לקמפיין, אתר ורשתות חברתיות.",
    keywords: [
      "סרט תדמית",
      "וידאו לעסק",
      "הפקת תדמית",
  ...
  "video-presentation": {
    ...
    metaTitle: "מצגת וידאו לאירועים וכנסים",
    metaDescription:
      "הפקת מצגות וידאו מקצועיות - עריכה, אנימציה, סאונד ומיתוג. מתאים לכנסים, אירועי חברה והשקות.",
    keywords: [
      "מצגת וידאו",
      "וידאו לכנס",
      "הפקת מצגת",
  ...
  "video-photo-slideshow": {
    ...
    metaTitle: "מצגת תמונות לאירוע | עריכה קולנועית תוך 48 שעות",
    metaDescription:
      "הפקת מצגות תמונות מרגשות לחתונות, בר/בת מצווה, ימי הולדת ופרישה. עריכה קולנועית, שילוב פסקול, שדרוג תמונות ישנות ומסירה מוכנה להקרנה.",
    keywords: [
      "מצגת תמונות לאירוע",
      "סלייד שואו",
      "עריכת מצגת",
...
export const PHOTOGRAPHY_SERVICES = {
  "photography-hub": {
    ...
    metaDescription:
      "צילום חתונות, אירועים וכנסים - סגנון מקצועי, עריכה מקצועית וחבילות גמישות. שירות ממודיעין לכל הארץ.",
    keywords: [
      "צילום חתונות",
      "צילום אירועים",
      "צלם לאירוע",
  ...
  "photography-wedding": {
    ...
    metaDescription:
      "צלם חתונות דתי ומקצועי לאירועים קטנים  -  שקיפות מלאה, עריכה כלולה, תמונות ראשונות תוך 48 שעות. מודיעין והמרכז.",
    keywords: [
      "צלם חתונות",
      "צילום חתונה",
      "צלם חתונות דתי",
  ...
  "photography-events": {
    ...
    metaDescription:
      "צילום סטילס לאירועים וכנסים - כיסוי מלא, עריכה מהירה ומסירה לשימוש שיווקי וארגוני.",
    keywords: [
      "צילום כנסים",
      "צילום אירוע עסקי",
      "צלם לאירוע חברה",
