...
export const STUDIO_SERVICES = {
  "studio-hub": {
    ...
    slug: "studio",
    category: "studio",
    title: "אולפן הקלטות במודיעין - מחיר שקוף, הקלטה מבוססת חומרה",
    subtitle:
      "חדרים מבודדים, רצפה צפה וגג מבודד. שרשרת ההקלטה מבוססת על מפרט תעשייתי מוכח: Townsend Sphere L22, ממשקי UAD, SM75, Electro-Voice RE20, RCF 745 ומערכות Allen & Heath.",
    metaTitle: "אולפן הקלטות ופודקאסט במודיעין - חומרה",
    metaDescription:
      "אולפן במודיעין לבידוד אקוסטי מלא ורצפה צפה. שרשרת סאונד עם UAD, Sphere L22 ו-Allen & Heath.",
    keywords: [
      "אולפן הקלטות",
      "סטודיו מודיעין",
      "הקלטת שיר",
    ...
    features: [
      "Townsend Sphere L22 + UAD Apollo Twin + Electro-Voice RE20",
      "חדרים מבודדים, רצפה צפה, גג מבודד - ללא החזרי תדר",
      "4 מתחמי הקלטת פודקאסט, 3 מצלמות קבועות, בקרה מרכזית",
      "עריכה ומיקס ביום ההקלטה - קובץ מוכן תוך 4 ימים",
      "חנייה חופשית, נגיש מירושלים והמרכז",
    ],
  ...
  "recording-song-modiin": {
    ...
    subtitle: "הקלטת שיר באולפן מקצועי. ליווי ווקאלי, עריכת סאונד ומסירה תוך 48 שעות.",
    metaTitle: "הקלטת שיר באולפן מודיעין - תוך 48 שעות",
    metaDescription:
      "שירות קריינות אנושית והקלטת שיר מקצועית במודיעין. תיקון זיופים מקצועי, ליווי טכני מלא ומסירה תוך 48 שעות. בר מצווה, חתונה וכניסה לחופה - קול נקי ואנושי, ללא AI-רובוטי.",
    keywords: [
      "קריינות אנושית לאירועים מודיעין",
      "תיקון זיופים מקצועי",
      "הקלטת שיר מודיעין",
      "הקלטת שיר לבר מצווה",
    "הקלטת שיר לחתונה",
  ...
  "blessings-hub": {
    ...
    subtitle:
      "הקלטה מקצועית באולפן או מהבית, כולל מוזיקת רקע, עריכת סאונד ומסירה מוכנה לאירוע.",
