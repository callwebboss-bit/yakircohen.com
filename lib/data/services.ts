...
export const STUDIO_SERVICES = {
  "studio-hub": {
    ...
    subtitle:
      "האולפן במודיעין. הקלטת שיר באולפן, ברכה או פודקאסט - חדר אקוסטי, ליווי אישי וקובץ מוכן.",
    metaTitle: "אולפן הקלטות במודיעין | שיר ופודקאסט",
    metaDescription:
      "אולפן הקלטות במודיעין. הקלטת שיר באולפן, ברכה ופודקאסט. חניה בשפע, נגיש מהמרכז ומירושלים.",
    keywords: [
    ...
    features: [
      "מיקום: מודיעין - חניה בשפע ליד האולפן",
      "הקלטת שיר, ברכה, פודקאסט והקלטות לאירועים",
      "חדר אקוסטי, ציוד מקצועי וליווי גם בפעם הראשונה",
      "מסירה מהירה - קובץ מוכן בלי הפתעות",
      "נגיש מירושלים, השפלה והמרכז",
    ],
    assetsFolder: "studio/hub",
    playlistEmbedUrl: youtubeEmbedUrl(YOUTUBE_SERVICE_EMBED_IDS["studio-hub"]),
    mediaType: "video",
    whatsappText: "שלום, מעוניין לשמוע על שירותי האולפן במודיעין",
    ...
    faqs: [
      ...
      },
      {
        ...
        question: "מעולם לא הקלטתי. אפשר להגיע?",
        answer:
          "כן, רוב הלקוחות מגיעים בפעם הראשונה. מנחים אתכם בכל שלב - מיקרופון, קצב, ביצוע. יוצאים עם קובץ שנשמע מקצועי, לא 'הקלטה מהנייד'.",
      },
      {
        id: "studio-price",
  ...
  "studio-recording-studio": {
    ...
    title: "אולפן הקלטות במודיעין",
    subtitle:
      "20 שנות ניסיון בהפקה מוזיקלית. Cubase, Suno AI ומיקרופוני Neumann - מתודולוגיית עבודה מוגדרת ותוצאה ברמת ספוטיפיי, כאן במודיעין.",
    metaTitle: "אולפן הקלטות מקצועי במודיעין - חומרה",
    metaDescription:
      "אולפן הקלטות מקצועי במודיעין. Cubase, AI, ציוד Neumann ו-Apollo, ליווי אישי מהסקיצה ועד המאסטר.",
    keywords: [
  ...
  "recording-song-modiin": {
    ...
    mediaType: "video",
    whatsappText: "שלום, מעוניין בהקלטת שיר באולפן במודיעין",
    ...
    faqs: [
      ...
      {
        id: "outside-modiin",
        question: "הקלטת שיר באולפן מתאימה גם למי שמגיע מחוץ למודיעין?",
        answer:
          "כן. האולפן במודיעין. תיאום ושליחת טקסטים מרחוק, והקלטה במקום. מרחובות כ-25-30 דקות, משוהם ומכבים ורעות נסיעה קצרה. אפשר גם אולפן נייד בתיאום.",
      },
      {
        id: "delivery-48h",
      ...
      },
      {
        ...
        answer:
          "ההקלטה עצמה באולפן במודיעין. תיאומים ושליחת טקסטים נעשים מרחוק. מרחובות כ-25-30 דקות (ראו אולפן הקלטות ברחובות). ממכבים ורעות כ-15 דקות.",
      },
      {
        id: "video-clip",
    ...
    hubCard: {
      ...
      description: "אולפן במודיעין - מהרעיון ועד שיר מוגמר.",
    },
    showInStudioHub: true,
  },
  ...
  "studio-rehovot": {
    ...
    faqs: [
      {
        id: "has-studio-rehovot",
        question: "יש אולפן הקלטות ברחובות?",
        answer:
          "אין סניף פיזי ברחובות. האולפן במודיעין, כ-25-30 דקות מרחובות. אפשר גם להזמין אולפן נייד שיגיע אליכם ברחובות.",
      },
      {
      ...
      },
      {
        ...
        question: "מה אפשר להקליט כשמגיעים מרחובות?",
        answer:
          "שיר, ברכה, דרשה, קריינות או פודקאסט - באולפן במודיעין או באולפן נייד ברחובות, לפי מה שמתאים לכם.",
      },
      {
        id: "location",
        question: "האם האולפן נמצא ברחובות?",
        answer:
          "לא. אין סניף פיזי ברחובות. האולפן המלא במודיעין, כ-25-30 דקות מרחובות. אפשר גם להזמין אולפן נייד שיגיע אליכם ברחובות.",
      },
      {
        id: "drive-time",
        question: "כמה זמן נסיעה מרחובות לאולפן?",
        answer:
          "כ-25-30 דקות מרחובות למודיעין, בעיקר דרך כביש 431 או נתיבי איילון.",
      },
      {
        id: "two-options",
        question: "מה ההבדל בין להגיע למודיעין לבין אולפן נייד ברחובות?",
        answer:
          "במודיעין מקליטים בחדר האקוסטי של האולפן. באולפן נייד אנחנו מגיעים אליכם עם סאונד, תאורה וציוד - זה לא החדר במודיעין, אבל מקבלים סאונד מקצועי לשירה, קריינות או פודקאסט לפי השירות שהזמנתם.",
      },
      {
        id: "mobile-includes",
      ...
      },
      {
        ...
        question: "האם מתאים להקלטת שיר, ברכה או דרשה?",
        answer:
          "כן. באולפן במודיעין או באולפן נייד - לפי בחירתכם. מקליטים שיר לחופה, ברכה, דרשה, קריינות או פודקאסט.",
      },
      {
    ...
    hubCard: {
      title: "אולפן הקלטות ברחובות",
      description: "25-30 דק׳ למודיעין, או אולפן נייד עד אליכם.",
    },
    showInStudioHub: true,
  },
  ...
  "studio-mobile-studio": {
    ...
    category: "studio",
    title: "אולפן נייד - מגיע עד אליכם",
    subtitle:
    ...
    features: [
      ...
      "סאונד מקצועי לשירה, קריינות או פודקאסט - לפי השירות שהזמנתם",
    ...
    faqs: [
      ...
      {
        id: "scheduling",
        question: "מתי מתאמים אולפן נייד?",
        answer:
          "שולחים תאריך ומיקום בוואטסאפ. מענה אנושי בשעות הפעילות. אחרי אישור מגיעים כ-30 דקות לפני ההקלטה להקמת ציוד.",
      },
      {
        id: "room",
      ...
      },
      {
        ...
        answer:
          "זה לא החדר האקוסטי במודיעין. מגיעים עם סאונד, תאורה וציוד מקצועי לשירה, קריינות או פודקאסט - לפי השירות שהזמנתם. התוצאה נקייה ומקצועית, במקום שבו אתם נמצאים.",
      },
      {
        id: "clip",
  ...
  "blessings-bar-mitzvah": {
    ...
    keywords: [
      "הקלטת ברכה לבר מצווה",
      "דרשה לבר מצווה",
      "ברכות בר מצווה",
      "הקלטת דרשה לבר מצווה",
      "ברכת הכהנים הקלטה",
      "שיר ברכה לבר מצווה",
      "אולפן הקלטות בר מצווה",
      "ברכה לבת מצווה",
      "הקלטת ברכה לאירוע",
    ],
    features: [
    ...
    faqs: [
      ...
      {
        id: "what-to-record",
        question: "מה אפשר להקליט לבר ובת מצווה?",
        answer:
          "דרשה לבר מצווה, ברכת הכהנים, ברכות מסבא וסבתא, ברכות מחברים שלא יכולים להגיע, ושיר ברכה מקורי עם שם הילד. אפשר גם לשלב קליפ וידאו.",
      },
      {
        id: "duration",
      ...
      },
      {
        ...
        answer:
          "מומלץ להקליט 2 עד 4 שבועות לפני האירוע, כדי לאפשר עריכה רגועה ותיקונים במידת הצורך.",
      },
    ],
    hubCard: {
      title: "בר/בת מצווה",
  ...
  "blessings-bride-groom": {
    ...
    faqs: [
      ...
      },
      {
        ...
        question: "מתי מקבלים את הקובץ?",
        answer:
          "בדרך כלל תוך 2-3 ימי עבודה מההקלטה. לפרויקטים דחופים לפני חתונה - כותבים בוואטסאפ ונבדוק זמינות.",
      },
      {
        id: "bride-groom-video",
        question: "אפשר לשלב וידאו?",
        answer:
          "כן. אפשר להוסיף קליפ וידאו עם ההקלטה. נפרט במחירון או בוואטסאפ לפי מה שצריך באירוע.",
      },
    ],
    hubCard: {
      title: "ברכת חתן וכלה",
      description: "ברכת חתן וכלה מוקלטת ומלוטשת ליום החתונה.",
    },
    showInStudioHub: false,
  },
  ...
  "blessings-video-clip": {
    ...
    subtitle:
      "הקלטה ווקאלית באיכות אולפן, צילום מוקפד ועריכת קליפ מוכן למשפחה, לרשת החברתית או לאירוע.",
...
export const STUDIO_PRICING: StudioPricingConfig = {
  ...
  tiers: [
    ...
    },
    {
      ...
      description: "הפקה מקצועית לסטרימינג - לא שיר מתנה.",
      highlights: [
        "עד 6 שעות אולפן כולל עריכה",
        "עיבוד, מיקס ומאסטר מסחרי",
        "ליווי יצירתי מלא",
      ],
    ...
    },
    {
      ...
      description: "שעת חדר לפיילוט פודקאסט או קריינות - בלי מיקס.",
      highlights: [
    ...
    },
    {
      ...
      description: "שעת חדר לקריינות או פרויקט בלי מיקס.",
      highlights: [
...
export const VOICEOVER_SERVICES = {
  "voiceover-hub": {
    ...
    slug: "voiceover",
    category: "voiceover",
    title: "קריינות מקצועית לסרטונים ומרכזיות - עם הנחיה ועריכה",
    subtitle:
    ...
    faqs: [
      {
        id: "voiceover-use",
        question: "לאיזה סוגי פרויקטים מתאימה קריינות?",
        answer:
          "פרסומות, סרטוני תדמית, מצגות, הדרכות, IVR ומרכזיות טלפון. כל פרויקט מקבל כיוון קולי ועריכה שמתאימים לפלטפורמה.",
      },
      {
        id: "voiceover-process",
        question: "איך התהליך עובד?",
        answer:
          "מגדירים טקסט וסגנון, מקליטים באולפן במודיעין, עורכים ומנקים רעשים. מקבלים קובץ מוכן לשידור או להטמעה במערכת.",
      },
      {
        id: "voiceover-languages",
        question: "באילו שפות אפשר להקליט?",
        answer:
          "עברית מלאה. לאנגלית או שפות נוספות - בודקים בוואטסאפ לפי הצורך והפרויקט.",
      },
      {
        id: "voiceover-turnaround",
        question: "כמה זמן לוקח?",
        answer:
          "רוב הקלטות קריינות קצרות מוכנות תוך 24-48 שעות. פרויקט ארוך או מרובה קטעים - נציין לוח זמנים בהצעה.",
      },
      {
        id: "voiceover-price",
        question: "איך מחושב המחיר?",
        answer:
          "לפי אורך הטקסט, סוג השימוש ורמת העריכה. מחיר פתיחה מופיע במחירון - הצעה סופית בוואטסאפ לפני הקלטה.",
      },
      {
        id: "voiceover-versions-revisions",
        question: "כמה גרסאות מקבלים, ואפשר לבקש תיקונים?",
        answer:
          "מקליטים 3 גרסאות ביצוע של אותו טקסט, עם ניואנסים שונים, כדי לבחור מה מתאים. אחרי בחירת גרסה כלולים עד 2 סבבי תיקונים, עד שהתוצר הסופי מאושר.",
      },
    ],
    hubCard: null,
    showInStudioHub: false,
...
export const EVENTS_SERVICES = {
  "events-hub": {
    ...
    slug: "events",
    category: "events",
    title: "DJ, הגברה ואטרקציות לאירועים - מודיעין, ירושלים, מחיר שקוף",
    subtitle:
    ...
    metaTitle: "DJ ואטרקציות לאירועים - מודיעין והמרכז",
    metaDescription:
    ...
    faqs: [
      {
        id: "events-how-early",
        question: "כמה מוקדם להזמין?",
        answer:
          "לחתונות וארועים גדולים - לפחות 3-4 חודשים מראש, בייחוד לתאריכים עמוסים (קיץ, חגים). לאירועים קטנים יותר - אפשר גם בהתראה קצרה יותר. שאלו על זמינות.",
      },
      {
        id: "events-what-included",
        question: "מה כלול בחבילה?",
        answer:
          "תלוי בחבילה שבוחרים. בחבילה בסיסית: DJ + הגברה. חבילות מורחבות כוללות אטרקציות (עשן, זיקוקים, קונפטי), תיאום מול האולם ותמיכה מלאה ביום האירוע.",
      },
      {
        id: "events-area",
        question: "לאיזה אזורים מגיעים?",
        answer:
          "מודיעין, ירושלים, השפלה ואזור המרכז. לאירועים בירושלים יש תוספת הגעה שמצוינת מראש בהצעת המחיר.",
      },
      {
        id: "events-venue-coordination",
        question: "מי מתאם עם מנהל האולם?",
        answer:
          "אנחנו. לפני כל אירוע אנחנו מתקשרים ישירות עם האולם - בודקים חיבורי חשמל, גובה תקרה, אישורי אפקטים ולוח זמנים. אתם לא מתעסקים עם הלוגיסטיקה.",
      },
      {
        id: "events-backup",
        question: "מה קורה אם יש תקלה ביום האירוע?",
        answer:
          "מגיעים עם ציוד גיבוי לכל אלמנט קריטי. 20 שנות ניסיון - ידענו להתמודד עם כל תקלה. לא פעם אחת השאר אירוע בלי מוזיקה.",
      },
    ],
    hubCard: null,
    showInStudioHub: false,
  ...
  "events-dj": {
    ...
    category: "events",
    title: "DJ לחתונות ואירועים - מודיעין, ירושלים, כל הארץ",
    subtitle:
      "רחבת ריקודים מתפקדת היא תוצאה של ניהול קצב נכון, סנכרון לוחות זמנים והתאמה עובדתית לקהל בשטח. השירות ניתן בפריסה ארצית מלאה.",
    metaTitle: "דיג׳יי לחתונה במודיעין - ירושלים והמרכז",
    metaDescription:
      "DJ ומנהל מוזיקלי במודיעין, ירושלים וכל הארץ. שיטת עבודה מוגדרת למניעת טעויות ברחבה: ניהול אישי או פיקוח מלא על צוות תקליטנים מנוסה.",
    keywords: [
      "דיגגיי במודיעין",
      "דיגגיי בשוהם",
      "דיגגיי בירושלים",
      "ניהול מוזיקלי לאירועים",
      "דיגגיי לחתונה בוטיק",
    ],
    features: [
  ...
  "events-bar-mitzvah": {
    id: "events-bar-mitzvah",
    slug: "events/bar-mitzvah",
    category: "events",
    title: "הפקת בר מצווה ובת מצווה - DJ, אפקטים והגברה",
    subtitle:
      "אירוע שמאחד שלושה דורות דורש רפרטואר גמיש, לוח זמנים שמכבד את הדרשה ואת הברכות, ורגעי שיא מתוזמנים מראש. ספק אחד לכל מה שנשמע ונראה, בפריסה ארצית.",
    metaTitle: "הפקת בר מצווה ובת מצווה - DJ ואטרקציות",
    metaDescription:
      "DJ, אפקטים, הגברה לדרשה ומצגת גדילה לבר מצווה ובת מצווה. מחירון שקוף, חבילת פסטיבל הכל כלול, ותיאום מול האולם. מודיעין, ירושלים וכל הארץ.",
    keywords: [
      "תקליטן לבר מצווה",
      "DJ לבת מצווה",
      "הפקת בר מצווה",
    ...
    features: [
      "רפרטואר שעובד גם על הנוער וגם על הדור המבוגר",
      "מיקרופון אלחוטי וניהול סאונד לדרשה, לברכות ולנאומים",
      "כניסה עם אפקט מתוזמן: עשן כבד, זיקוקים קרים או קונפטי",
      "מצגת גדילה מתמונות הילדות, מעובדת ומסונכרנת למוזיקה",
      "הקלטת הדרשה באולפן מראש, לגיבוי או להשמעה באירוע",
    ],
    pricing: [
      {
        name: "DJ לאירוע",
      ...
      {
        /* בכוונה בלי מספר: סכום שני פריטי הקטלוג הוא מחיר מלא, והאתר מוכר את אותו
        ...
        description:
          "ההרכב המבוקש: תקליטן ושלוש אטרקציות לכניסה, להרמה ולרגע השיא. נסגר כחבילה אחת מול התאריך והמיקום.",
        featured: true,
        badge: "הכי מבוקש",
      },
      {
        ...
        description:
          "תקליטן פרימיום, אולפן נייד בשטח, שלוש אטרקציות, מצגת וטכנאי צמוד לאורך הערב.",
      },
      {
        name: "מצגת גדילה מתמונות",
        price: formatNis(getExVat("growth_slideshow_50")),
        priceExVat: getExVat("growth_slideshow_50"),
        catalogId: "growth_slideshow_50",
        priceNote: "50 תמונות. גרסאות 30 / 70 / 100 במחירון",
        description:
          "תמונות מהילדות עד היום, שיפור AI, מוזיקה, פתיחה וסגירה. מוכן להקרנה על מסך באולם.",
      },
    ],
    assetsFolder: "events/dj-events",
    playlistEmbedUrl: youtubeEmbedUrl(YOUTUBE_SERVICE_EMBED_IDS["events-dj"]),
    mediaType: "video",
    whatsappText:
      "שלום, מעוניין/ת בהפקת בר/בת מצווה. אשמח להצעת מחיר ותיאום",
    utmCampaign: "events_bar_mitzvah",
    scarcityLabel: "עונת בר המצוות (ספטמבר-נובמבר, מרץ-יוני) מתמלאת מוקדם",
    faqs: [
      {
        id: "bm-price",
      ...
      {
        id: "bm-vs-bat",
        question: "יש הבדל בין הפקת בר מצווה להפקת בת מצווה?",
        answer:
          "ההבדל הוא ברפרטואר ובמבנה הערב. בבת מצווה יש בדרך כלל יותר משקל לריקוד מתוכנן, למסיבת בנות ולצילום, ובבר מצווה למעמד הדרשה ולקטע התורה. הציוד וההגברה זהים, התכנון המוזיקלי שונה.",
      },
      {
        id: "bm-drasha",
        question: "אפשר להקליט את הדרשה מראש?",
        answer:
          "כן. מקליטים את הדרשה באולפן, מתקנים היסוסים ומוסיפים מוזיקת רקע. זה משמש כגיבוי אם יש לחץ במעמד, או כקטע שמושמע באולם. הפרטים בעמוד הקלטת דרשה לבר מצווה.",
      },
      {
        id: "bm-religious",
        question: "עובדים באירועים דתיים ובהפרדה?",
        answer:
          "כן. מתאימים רפרטואר, עוצמות והצבת רמקולים לפי אופי האירוע, כולל מחיצה והפרדה. מסכמים את הכללים מראש בפגישת התכנון.",
      },
      {
        id: "bm-area",
        question: "לאיזה אזורים מגיעים?",
      ...
      {
        id: "bm-when",
        question: "מתי כדאי לסגור?",
        answer:
          "עונת בר המצוות עמוסה בספטמבר עד נובמבר ובמרץ עד יוני. תאריך בעונה נסגר בדרך כלל 3 עד 6 חודשים מראש. מחוץ לעונה יש גמישות גדולה יותר.",
      },
    ],
    hubCard: {
      title: "בר מצווה ובת מצווה",
      description: "DJ, אפקטים, מצגת גדילה והקלטת דרשה.",
    },
    showInEventsHub: true,
    showInAttractionsHub: false,
  },
  "events-wedding-packages": {
    ...
    features: [
      ...
      `מחשבון חבילות + הצעה בוואטסאפ ${TIME_CLAIMS.quote24h}`,
    ],
    pricing: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        question: "מה כלול בחבילת DJ + אטרקציות?",
        answer:
          "DJ מקצועי, עד 3 אטרקציות לבחירה (עשן, זיקוקים, קונפטי, בועות ועוד), תיאום מול מנהל האירוע והגברה בשטח.",
      },
      {
        id: "wedding-pkg-book",
        question: "איך מזמינים?",
        answer:
          "משאירים פרטים ב-/book או כותבים בוואטסאפ עם תאריך, מיקום וסוג האירוע. מחזירים הצעה מפורטת, בדרך כלל תוך 24 שעות.",
      },
      {
        id: "wedding-pkg-area",
        question: "לאיזה אזורים אתם מגיעים?",
        answer:
          "מודיעין, השרון, ירושלים וכל הארץ בתיאום מראש. תוספת נסיעות מחוץ לאזור המרכז - לפי מרחק.",
      },
      {
        id: "wedding-pkg-festival",
        question: "מה בחבילת הפסטיבל?",
        answer:
          "DJ, אולפן נייד, 3 אפקטים, פסקול כניסה, מצגת וטכנאי בשטח. מתאימה לאירוע שרוצים הכל מספק אחד.",
      },
    ],
    hubCard: {
      title: "חבילות לחתונה",
  ...
  "events-attractions-hub": {
    ...
    subtitle:
      "עשן כבד, בועות סבון וקונפטי לחתונות ואירועים - מפעיל מקצועי ותיאום DJ. מגיעים לפתח תקווה, שוהם, מודיעין וכל אזור המרכז.",
    metaTitle: "אטרקציות לאירועים | עשן, בועות וקונפטי - אזור המרכז וכל הארץ",
    metaDescription:
      `אטרקציות לחתונה במודיעין ובמרכז: עשן, בועות וקונפטי. מפעיל מקצועי, תיאום DJ וצלם - הצעה ${TIME_CLAIMS.quote24h}.`,
    keywords: [
      "אטרקציות לחתונה",
      "אטרקציות לחתונה פתח תקווה",
      "אטרקציות לחתונה שוהם",
      "אטרקציות לאירועים אזור המרכז",
      "אטרקציות לחתונה מודיעין",
      "מכונת עשן לאירוע",
      "תותח קונפטי",
      "מכונת בועות",
    ],
    ...
    faqs: [
      {
        id: "attractions-types",
        question: "אילו אטרקציות זמינות?",
        answer:
          "עשן כבד, זיקוקים קרים, קונפטי, בועות, עשן צבעוני ועוד. כל אפקט מופעל על ידי צוות מנוסה עם ציוד מתוחזק.",
      },
      {
        id: "attractions-safety",
        question: "האם זה בטוח באולם סגור?",
        answer:
          "זיקוקים קרים ועשן מיועדים לשימוש מבוקר באולמות. מתאמים מול המקום, DJ וצלם לפני האירוע.",
      },
      {
        id: "attractions-timing",
        question: "מתי מגיעים להפעלה?",
        answer:
          "מגיעים לפני האירוע לבדיקה והכנה. מפעילים ברגעי השיא לפי תסריט שתואם מראש.",
      },
      {
        id: "attractions-dj",
        question: "חייבים DJ שלכם?",
        answer:
          "לא חובה, אבל תיאום עם DJ מקצועי מוריד טעויות בטיימינג. אפשר לשלב DJ + אטרקציות בחבילה אחת.",
      },
      {
        id: "attractions-quote",
        question: "איך מקבלים הצעת מחיר?",
        answer:
          "כותבים בוואטסאפ: תאריך, מיקום, סוג אירוע ואילו אפקטים מעניינים. מחזירים הצעה, בדרך כלל תוך 24 שעות.",
      },
    ],
    hubCard: {
  ...
  "attractions-bubble-machine": {
    ...
    metaTitle: "מכונת בועות סבון לאירועים | בועות LED ועשן עם מפעיל מקצועי",
    metaDescription:
      `מכונת בועות לחתונה במודיעין ולכל הארץ. בועות LED ועשן, מפעיל צמוד, נוזל היפואלרגני - אישור ${TIME_CLAIMS.quote24h}.`,
    keywords: [
      "מכונת בועות סבון לחתונה",
      "השכרת מכונת בועות עם מפעיל",
      "מכונת בועות פתח תקווה",
      "בועות סבון שוהם",
      "מכונת בועות אזור המרכז",
      "בועות סבון לאירוע",
      "בועות LED לסלואו",
      "מכונת בועות לבר מצווה",
      "בועות עשן",
      "בועות לחופה",
    ],
    features: [
    ...
    hubCard: {
      title: "מכונת בועות סבון",
      description: "בועות LED ועשן - מפעיל מקצועי, תיאום DJ וצלם.",
    },
    showInEventsHub: false,
  ...
  "attractions-wedding-smoke": {
    ...
    subtitle:
      "ענן עשן כבד בגובה הברך, ללא ריח וללא החלקה. 100% קרח יבש, בטוח לאולמות סגורים ולחוץ. תיאום מלא עם DJ וצלם.",
    metaTitle: `עשן כבד לחתונה וסלואו | קרח יבש לכניסה לחופה - אישור ${TIME_CLAIMS.quote24h}`,
    metaDescription:
      "עשן כבד לחתונה במודיעין ולכל הארץ. ענן לבן בגובה הברך, מפעיל מקצועי ותיאום DJ וצלם.",
    keywords: [
      "עשן כבד לחתונה",
      "עשן כבד פתח תקווה",
      "עשן כבד שוהם",
      "קרח יבש ראשון לציון",
      "עשן כבד לסלואו",
      "קרח יבש לכניסה לחופה",
      "מכונת עשן כבד עם מפעיל",
      "עשן כבד לריקוד ראשון",
      "קרח יבש לאירוע",
      "השכרת עשן כבד",
    ],
    features: [
    ...
    hubCard: {
      title: "עשן כבד וקרח יבש",
      description: "ענן לבן לסלואו וחופה - מעל 1,800 אירועים, מפעיל מקצועי.",
    },
    showInEventsHub: false,
    showInAttractionsHub: true,
  },
  ...
  "attractions-confetti-cannon": {
    ...
    metaTitle: `תותח קונפטי לחתונה ובר מצווה | השכרה עם מפעיל - אישור ${TIME_CLAIMS.quote24h}`,
    metaDescription:
      "תותח קונפטי לחתונה במודיעין ולכל הארץ. עד 30 מטר, CO2 בטוח, מפעיל מקצועי ותזמון עם ה-DJ.",
    keywords: [
      "תותח קונפטי לחתונה",
      "תותח קונפטי פתח תקווה",
      "קונפטי לחתונה שוהם",
      "תותח קונפטי אזור המרכז",
      "השכרת תותח קונפטי עם מפעיל",
      "קונפטי לכניסה לחופה",
      "קונפטי לבר מצווה",
      "תותח קונפטי",
      "קונפטי לאירועים",
    ...
    hubCard: {
      title: "תותח קונפטי",
      description: "עד 30 מטר קונפטי ברגע השיא - מפעיל מקצועי ותזמון עם DJ.",
    },
    showInEventsHub: false,
    showInAttractionsHub: true,
  },
  ...
  "attractions-cold-fireworks": {
    ...
    metaTitle: "זיקוקים קרים לחתונה | אש קרה בטוחה לאולמות - אזור המרכז",
    metaDescription:
      "זיקוקים קרים לחתונה במודיעין ולכל הארץ. 4 מכונות, בטוח באולם סגור, מפעיל מקצועי.",
    keywords: [
      "זיקוקים קרים לחתונה",
      "זיקוקים קרים פתח תקווה",
      "Cold Sparklers שוהם",
      "זיקוקים קרים לבר מצווה",
      "אש קרה לחתונה אזור המרכז",
      "זיקוקים קרים",
      "זיקוקים לחופה",
      "Cold Sparklers",
      "אש קרה לאירוע",
  ...
  "attractions-giant-balloons": {
    ...
    metaTitle: "בלוני ענק לאירועים | עיצוב מרשים לחתונה ובר מצווה - אזור המרכז",
    metaDescription:
      `בלוני ענק לחתונה במודיעין ולכל הארץ. עיצוב מרשים והתקנה מקצועית - הצעה ${TIME_CLAIMS.quote24h}.`,
    keywords: [
      "בלוני ענק לחתונה",
      "בלוני ענק פתח תקווה",
      "בלונים לאירוע שוהם",
      "עיצוב בלונים לבר מצווה",
      "בלוני ענק",
      "בלונים לאירוע",
      "אטרקציה לרחבה",
      "עיצוב אירוע",
  ...
  "attractions-led-booth": {
    ...
    metaDescription:
      `עמדת LED לחתונה במודיעין ובמרכז. P3.91, Resolume ומיתוג מותאם - הצעה ${TIME_CLAIMS.quote24h}.`,
    keywords: [
      "עמדת LED לחתונה",
      "עמדת DJ לד פתח תקווה",
      "מסך LED שוהם",
      "עמדת לד לאירוע אזור המרכז",
      "עמדת LED",
      "עמדת DJ LED",
      "השכרת עמדת לד",
      "מסך LED לאירוע",
  ...
  "attractions-smoke-cannons": {
    ...
    metaTitle: "תותחי עשן לחתונות ואירועים | אפקט דרמטי - אזור המרכז",
    metaDescription:
      "תותחי עשן לחתונה במודיעין ולכל הארץ. אפקט דרמטי, הפעלה מקצועית ותיאום DJ.",
    keywords: [
      "תותחי עשן לחתונה",
      "תותחי עשן פתח תקווה",
      "עשן לאירוע שוהם",
...
/**
 * החזר מלא בכוח עליון, החלטת הבעלים מ-7.9.2026.
 *
 * מוזרק כאן ולא ב-17 מערכי ה-faqs בנפרד, כי הבטחה משפטית שכתובה
 * שבע עשרה פעמים תסטה. נקודה אחת, נוסח אחד, וכל 32 עמודי האירועים
 * עוברים דרך הגטר הזה. הוא נכנס גם לתצוגה וגם ל-FAQPage שגוגל קורא.
 */
export const EVENTS_FORCE_MAJEURE_FAQ: ServiceFaq = {
  id: "force-majeure-refund",
  question: "מה קורה אם האירוע מתבטל בגלל מלחמה או מצב חירום?",
  answer:
    "אם האירוע לא יכול להתקיים בגלל נסיבות שאינן בשליטת אף אחד מהצדדים, אתם מקבלים החזר כספי מלא. בלי דמי ביטול ובלי שיקול דעת מצדנו. זה כולל מלחמה או הסלמה ביטחונית עם הגבלות פיקוד העורף, מגפה או הגבלת התקהלות מטעם הרשויות, ואסון טבע. אפשר גם לבחור בדחיית התאריך במקום החזר, בלי תוספת תשלום. הנוסח המחייב נמצא בתנאי השירות.",
};

export function getEventsService(id: EventsServiceId): ServiceEntity {
  const service = EVENTS_SERVICES[id];
  return { ...service, faqs: [...service.faqs, EVENTS_FORCE_MAJEURE_FAQ] };
}
...
export const VIDEO_SERVICES = {
  "video-hub": {
    ...
    faqs: [
      {
        id: "video-types",
        question: "אילו סוגי וידאו אתם מפיקים?",
        answer:
          "צילום אירועים, סרטי תדמית לעסקים, מצגות וידאו לכנסים והשקות. מהתסריט ועד עריכה וצבע במקום אחד.",
      },
      {
        id: "video-process",
        question: "איך מתחילים פרויקט?",
        answer:
          "שיחה קצרה להבנת המטרה, תקציב ולוח זמנים. אחר כך תסריט/תכנון צילום, יום צילום ומסירת קבצים בפורמט שמתאים לשימוש שלכם.",
      },
      {
        id: "video-delivery",
        question: "באיזה פורמט מקבלים את הסרט?",
        answer:
          "MP4 לאתר ורשתות, וריאנטים לרזולוציות שונות לפי הצורך. מצגות ארוכות - גם גרסה לפרויקטור.",
      },
      {
        id: "video-area",
        question: "איפה אתם מצלמים?",
        answer:
          "מודיעין והמרכז כבסיס. אירועים בפריפריה - בתיאום מראש עם תוספת נסיעות.",
      },
      {
        id: "video-audio",
        question: "אפשר לשלב סאונד מהאולפן?",
        answer:
          "כן. קריינות, פסקול ועריכת סאונד מהסטודיו שלנו - חוסך תיאום בין ספקים.",
      },
    ],
    hubCard: null,
  ...
  "video-photo-slideshow": {
    ...
    category: "video",
    title: "מצגת תמונות קולנועית לאירועים",
    subtitle:
      "תמונות משפחתיות מהילדות ועד היום, עם עריכה קולנועית, מוזיקה ואפקטים. מוכנה להקרנה באירוע.",
    ...
    hubCard: {
      ...
      description: "עריכה קולנועית מתמונות וקטעי וידאו שלכם.",
    },
    showInVideoHub: true,
...
export const PHOTOGRAPHY_SERVICES = {
  "photography-hub": {
    ...
    faqs: [
      {
        id: "photo-events",
        question: "מה כולל צילום חתונה או אירוע?",
        answer:
          "צילום לאורך האירוע, עריכה בסיסית ומסירה דיגיטלית מסודרת. סגנון טבעי ומכובד - בלי פוזות מוגזמות.",
      },
      {
        id: "photo-booking",
        question: "מתי כדאי לשריין צלם?",
        answer:
          "לחתונות - כמה חודשים מראש. לאירוע עסקי או כנס - לפחות 2-3 שבועות. תאריכים חמים נסגרים מהר.",
      },
      {
        id: "photo-delivery",
        question: "מתי מקבלים את התמונות?",
        answer:
          "בדרך כלל תוך 2-4 שבועות מסיום האירוע, לפי היקף העריכה. דחוף? בודקים בוואטסאפ לפני הזמנה.",
      },
      {
        id: "photo-video-bundle",
        question: "אפשר לשלב צילום ווידאו?",
        answer:
          "כן. אותו צוות יכול לתאם צילום ווידאו כדי שהסגנון והטיימינג יהיו אחידים.",
      },
      {
        id: "photo-price",
        question: "איך בנוי המחיר?",
        answer:
          "לפי שעות כיסוי, מיקום וחבילת עריכה. רואים טווח במחירון - הצעה מדויקת בוואטסאפ אחרי פרטי האירוע.",
      },
    ],
    hubCard: null,
    showInVideoHub: false,
