  ...
  "blessings-bar-mitzvah": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "ברכה קצרה: 30 עד 60 דקות. דרשה ארוכה: שעה עד שעתיים. בסוף מקבלים קובץ מוכן תוך 24 שעות.",
      },
      {
        id: "location",
...
export const EVENTS_SERVICES = {
  ...
  "events-attractions-hub": {
    ...
    metaDescription:
      "אטרקציות לחתונה במודיעין ובמרכז: עשן, בועות וקונפטי. מפעיל מקצועי, תיאום DJ וצלם - הצעה תוך 24 שעות.",
    keywords: [
      "אטרקציות לחתונה",
  ...
  "attractions-bubble-machine": {
    ...
    metaDescription:
      "מכונת בועות לחתונה במודיעין ולכל הארץ. בועות LED ועשן, מפעיל צמוד, נוזל היפואלרגני - אישור תוך 24 שעות.",
    keywords: [
  ...
  "attractions-wedding-smoke": {
    ...
    metaTitle: "עשן כבד לחתונה וסלואו | קרח יבש לכניסה לחופה - אישור תוך 24 שעות",
    metaDescription:
  ...
  "attractions-confetti-cannon": {
    ...
    metaTitle: "תותח קונפטי לחתונה ובר מצווה | השכרה עם מפעיל - אישור תוך 24 שעות",
    metaDescription:
  ...
  "attractions-giant-balloons": {
    ...
    metaDescription:
      "בלוני ענק לחתונה במודיעין ולכל הארץ. עיצוב מרשים והתקנה מקצועית - הצעה תוך 24 שעות.",
    keywords: [
      "בלוני ענק לחתונה",
      "בלוני ענק פתח תקווה",
      "בלונים לאירוע שוהם",
