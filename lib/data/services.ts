...
export const STUDIO_SERVICES = {
  ...
  "studio-mobile-studio": {
    ...
    metaDescription:
      "אולפן נייד מגיע לכל הארץ. החל מ-999 ₪ לפני מע״מ + תוספת אזור. פנלים אקוסטיים, מיקרופונים ומפיק צמוד.",
    keywords: [
      "אולפן נייד",
      "אולפן הקלטות נייד",
      "הקלטת שיר בבית",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "החל מ-999 ₪ לפני מע״מ. תוספת אזור לפי מיקום: מרכז ללא תוספת, צפון/דרום +800 ₪, אילת/גולן +1,800 ₪.",
      },
      {
        id: "areas",
