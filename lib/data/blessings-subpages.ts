...
export const BAR_MITZVAH_WHY: readonly BlessingsWhyCard[] = [
  {
    ...
    description:
      "מקליטים בשקט, חוזרים על משפטים, מתרגלים עד שזה מדויק - בלי מבטים מהאולם.",
  },
  {
    emoji: "✏️",
    title: "עזרה בניסוח",
  ...
  },
  {
    ...
    title: "עריכה + מוזיקה",
    description:
      "תיקון זיופים, ניקוי רעשים ומוזיקת רקע עדינה - הברכה נשמעת רציפה ומקצועית.",
  },
  {
    emoji: "🎬",
    title: "אפשרות לקליפ",
    description:
      "רוצים גם וידאו? אפשר לשלב הקלטת שיר וקליפ - מתנה שתישאר לכל החיים.",
  },
] as const;
...
export const BRIDE_GROOM_WHY: readonly BlessingsWhyCard[] = [
  {
    ...
    title: "רגע אינטימי",
    description:
      "הקלטה פרטית באולפן - בלי מבטים, בלי לחץ. המילים יוצאות טבעי מהלב.",
  },
  {
    emoji: "👨‍👩‍👧",
    title: "מחבר בין דורות",
    description:
      "ברכה מההורים, מהסבים או מהחברים - שמכבדת את הזוג ונשארת לנצח.",
  },
  {
    emoji: "🎧",
    title: "הבדל ששומעים",
    description:
      "עריכה מקצועית, מוזיקה רגשית ומיקס - לא הקלטה ביתית, אלא מוצר מלוטש.",
  },
  {
    emoji: "⏱️",
...
export const BRIDE_GROOM_PROCESS: readonly BlessingsProcessStep[] = [
  ...
  },
  {
    step: "02",
    title: "הקלטה שקטה",
    description: "סביבה אינטימית, takes מרובים, ליווי עד שזה מרגיש נכון.",
  },
  {
    step: "03",
    title: "עריכה ומוזיקה",
    description: "מיקס, מוזיקת רקע ותיקונים - הברכה נשמעת מושלמת.",
  },
  {
    step: "04",
    title: "מסירה לחתונה",
...
export const VIDEO_CLIP_WHY: readonly BlessingsWhyCard[] = [
  ...
  {
    emoji: "🎁",
    title: "מתנה בלתי נשכחת",
    description:
      "שיר + קליפ - מתנה שמשפחות וחברים זוכרים שנים אחרי.",
  },
] as const;
