...
export const ATTRACTIONS: AttractionItem[] = [
  // ── אפקטים וזיקוקים ─────────────────────────────────────────────────────
  {
    id: "cold-fireworks",
    name: "זיקוקים קרים",
    shortDesc: "כניסה לחופה או רגע שיא בטקס",
    seoDesc:
  ...
  },
  {
    ...
    seoDesc:
      "תותח קונפטי מפצץ אלפי פיסות נייר צבעוניות לאוויר ויוצר גשם של אושר. הרגע הזה הוא אחד הצילומים הכי ויראליים מאירועים. זמין בנייר לבן, צבעוני, ב-1 או 2 תותחים.",
  ...
  },
  {
    id: "smoke-cannons",
    name: "תותחי עשן",
    shortDesc: "עשן ממוקד לרגעים מרכזיים",
    seoDesc:
      "תותחי עשן מייצרים ענני עשן ממוקדים לרגעי שיא באירוע. מתאים לכניסות, לריקוד סלואו ולכל רגע שאתם רוצים להפוך לבלתי נשכח.",
