...
export const CORPORATE_SONGS_CONFIG: BusinessPageConfig = {
  ...
  subtitle:
    "שיר פרישה, הימנון חברה וקליפ לערב חברה. הפקה מלאה מכתיבה עד מסירה - חשבונית מס. תגובה תוך 24 שעות.",
  pageFeatures: [
    "שיר מקורי והפקה מלאה באולפן",
    "קליפ לערב חברה, לינקדאין ויוטיוב",
    "חשבונית מס - מוכן לדיווח",
    "תגובה תוך 24 שעות - מודיעין ואזור המרכז",
  ],
  ...
  aboutParagraphs: [
    ...
    "HR מחפש מחווה מקורית לסמנכ\"ל יוצא, שיווק רוצה הימנון לאירוע שנתי, ההנהלה רוצה משהו שיזכרו. תגובה לפנייה תוך 24 שעות, חשבונית מס, וכל הזכויות עוברות לחברה.",
  ],
  faqs,
  differentiation: [
