...
export const CORPORATE_SONGS_CONFIG: BusinessPageConfig = {
  ...
  subtitle:
    "שיר פרישה, הימנון חברה, הרמת כוסית או קליפ לערב חברה. אותה מקצועיות כמו שיר במתנה.",
  pageFeatures: [
    "שיר מקורי והפקה באולפן",
    "קליפ לערב חברה או לינקדאין",
    "חשבונית מס",
    "מודיעין, ירושלים והמרכז",
  ],
  ...
  aboutParagraphs: [
    "חברות מזמינות שיר פרישה או קליפ לערב חברה באותה עבודה שאנחנו עושים לשיר במתנה. רק התקציב והמטרה שונים.",
    "HR מחפש מחווה מקורית, שיווק רוצה הימנון, ההנהלה רוצה משהו שיזכרו. אנחנו מכסים את כל זה.",
  ],
  faqs,
  differentiation: [
