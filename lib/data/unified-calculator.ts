...
export const UNIFIED_CALC_CATEGORIES: readonly CalcCategory[] = [
  {
    ...
    options: [
      ...
      { id: "cover", label: "שיר מוכן באולפן", note: "מיקס, מאסטר, תיקון זיופים", exVat: getExVat("cover_song") },
      { id: "package", label: "שיר Pro", note: "פיץ' ידני + תמונות + ייעוץ", exVat: getExVat("song_package") },
