...
export const PRO_SERVICES: readonly ProService[] = [
  ...
  },
  {
    ...
    subtitle:
      "חסר לכם מיקסר ליום אחד? בוחרים תאריך וציוד, רואים אם פנוי וכמה זה עולה.",
    metaTitle: "השכרת ציוד הגברה",
    metaDescription:
      "מיקסרים, סאבים, רמקולים ותאורה ליום. לחברות הגברה, מפיקים, וגם ל-DJ שמגיש אירוע בודד. החל מ-450 ₪ ליום.",
    keywords: [
      "השכרת ציוד הגברה",
      "השכרת מיקסר",
      "ציוד לאירוע",
    ...
    seoParagraphs: [
      "חברת הגברה שחסר לה מיקסר לסוף שבוע? DJ שמגיש חתונה וצריך רק סאב נוסף? המחשבון בודק מה פנוי בתאריך שלכם.",
      "אין טכנאי בשטח. אתם מכירים את הציוד, מגיעים לאסוף, ומחזירים. אם צריך מישהו לתפעל, יש שירות הגברה מלא בנפרד.",
    ],
    features: [
    ...
    faqs: [
      { question: "האם כולל טכנאי?", answer: "לא. זו השכרת ציוד בלבד. שירות הגברה עם טכנאי בעמוד נפרד." },
      { question: "DJ פרטי יכול לשכור?", answer: "כן. אם אתם מכירים את הציוד ויודעים לחבר, זה בדיוק בשבילכם." },
      { question: "איך מתעדכן המלאי?", answer: "לפי הזמנות פעילות. לתאריך צמוד, כדאי לאשר בוואטסאפ." },
      { question: "מה אם פריט תפוס?", answer: "המחשבון יגיד מה לא פנוי. נציע חלופה או תאריך אחר." },
    ],
