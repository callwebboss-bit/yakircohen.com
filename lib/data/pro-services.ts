...
export const PRO_SERVICES: readonly ProService[] = [
  ...
  },
  {
    ...
    seoParagraphs: [
      ...
      "עריכה ידנית: סולמות, קצב ומעברים. קובץ מוכן לאירוע, לא ניסוי מהיר במחולל.",
    ],
    features: [
      "שילובים עם BPM, Camelot והרמוניה בחינם",
      "דוגמאות ביוטיוב ושמירה לסט",
    ...
    processSteps: [
      ...
      { number: 4, title: "מסירה", description: "קובץ מוכן לנגן וגיבוי. בחבילה: כמה קבצים ברצף." },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "תלוי ברישוי ובאיכות. לרחבת ריקודים מקצועית עדיף רמיקס על שירים מוכרים או ייצור באולפן. לא תמיד מתאים לשידור חי.",
      },
      {
