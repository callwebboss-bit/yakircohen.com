...
export const FOR_COUPLES_LANDING: AudienceLandingConfig = {
  ...
  lead:
    "שיר במתנה, DJ לערב, צילום ואפקטים - הכול עם תיאום אחד ומחיר שקוף. תגובה, בדרך כלל תוך 24 שעות, ליווי טכני מלא.",
  crossLink: {
  ...
  faqs: [
    {
      ...
      answer:
        "שיר באולפן - מומלץ 2-3 שבועות לפני. DJ ואטרקציות - 2-3 חודשים מראש בעונת החתונות. תמיד אפשר לבדוק זמינות בוואטסאפ, בדרך כלל תוך 24 שעות.",
    },
    {
...
export const FOR_CREATORS_LANDING: AudienceLandingConfig = {
  ...
  lead:
    "אולפן במודיעין, מיקס מקוון, פודקאסט וקורסים - איכות אנושית בלי רובוטיקה. תמיכה טכנית מלאה, מסירה, בדרך כלל תוך 24 שעות.",
  crossLink: {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "רוב הפרויקטים - בדרך כלל תוך 24 שעות מסירה. פרויקטים מורכבים - נקבע לוח זמנים בהצעה.",
    },
  ],
