...
export const SINGER_EVENT_GUIDE: readonly {
  ...
  },
  {
    ...
    description:
      "בחופה ובטקסים, שנייה של שקט או פידבק באמצע משפט חשוב - זה מה שמפחיד. אנחנו בונים מערכת שמונעת את זה מראש.",
    gear: [
...
export const SINGER_WHY_BLOCKS: readonly {
  ...
  },
  {
    ...
    description: "30-45 דקות - לא \"טסט טסט\". עד שהסאונד מדויק ומאוזן.",
    bullets: [
      "רמות, EQ, קומפרסור",
      "התאמת מוניטורים",
...
export const SINGER_PROCESS: readonly {
  ...
  },
  {
    step: "04",
    title: "צ'ק סאונד",
    description: "30-60 דקות לפני - עד שהסאונד מדויק ומאוזן.",
  },
  {
    step: "05",
    title: "ההופעה + פירוק",
