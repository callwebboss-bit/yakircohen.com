...
/** תהליך קצר: מצב לפני העריכה מול מה שמקבלים אחרי */
export const PODCAST_EDITING_BEFORE_AFTER: readonly {
  id: "before" | "after";
  title: string;
  ...
  {
    id: "before",
    title: "לפני - הקלטה גולמית",
    points: [
      "רעשי רקע, הד או רעש מזגן",
      "עוצמות לא אחידות בין דוברים",
      "שתיקות ארוכות, גמגומים או חזרות",
      "בלי פתיחה/סיום ובלי נורמליזציה לפלטפורמות",
    ],
  },
  {
    id: "after",
    title: "אחרי - פרק מוכן להעלאה",
    points: [
      "ניקוי רעשים בלי לפגוע בקול",
      "איזון עוצמות ו-EQ לפי דובר",
      "חיתוך לזרימה טבעית",
      "MP3 מנורמל + סבב תיקונים אחד",
    ],
  },
] as const;
...
export const PODCAST_EDITING_FAQS: readonly {
  ...
  {
    id: "editing-turnaround",
    question: "כמה זמן לוקחת עריכת פודקאסט?",
    answer:
      "רוב הפרקים נמסרים בדרך כלל תוך 24-48 שעות משליחת הקובץ. פרק ארוך, כמה מקורות או שחזור ארכיון - עד כמה ימים, עם זמן מסירה ברור לפני שמתחילים.",
  },
  {
    id: "editing-includes",
    question: "מה כולל שירות עריכת הפודקאסט?",
    answer:
      "ניקוי רעשי רקע, שיפור קול ו-EQ, חיתוך וקיצורים, איזון עוצמות ונורמליזציה, אופציה למוזיקת פתיחה/סיום, סנכרון כמה מיקרופונים אם צריך, וקובץ MP3 מוכן להעלאה. סבב תיקונים אחד כלול. מחיר לפי שעת חומר גולמי.",
  },
  {
    id: "format",
