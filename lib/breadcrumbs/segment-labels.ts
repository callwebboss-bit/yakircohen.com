...
export const BREADCRUMB_SEGMENT_LABELS: Record<string, string> = {
  ...
  "studio-shoham": "אולפן לשוהם",
  "studio-rehovot": "אולפן לרחובות",
  shoham: "שוהם",
  rehovot: "רחובות",
  ...
  "corporate-podcast": "פודקאסט ארגוני",
...
export const BREADCRUMB_PATH_OVERRIDES: Record<string, string> = {
  ...
  "/dj-events/cities/rehovot": "תקליטן ברחובות",
  "/studio/studio-shoham": "אולפן לשוהם",
  "/studio/studio-rehovot": "אולפן לרחובות",
