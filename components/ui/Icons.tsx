 ...
 *
 * Every icon:
 *   • Accepts `size` (default 24 px) and `className` props.
 *   • Sets aria-hidden="true" + focusable="false" - icons are presentational;
...
/**
 * ArrowIcon - right-pointing by default.
 * Flip direction with `className="rotate-180"` (left), `-rotate-90` (up), `rotate-90` (down).
 */
...
/**
 * ChevIcon - downward-pointing chevron by default.
 * Use `className="-rotate-90"` (right), `rotate-90` (left), `rotate-180` (up).
 */
export function ChevIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CookieIcon({ size = 24, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 12v.01" strokeWidth={3} strokeLinecap="round" />
    </svg>
  );
}
...
export function VideoIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="m16 13 5-3-5-3v6ZM3 7h11v10H3z" />
    </svg>
  );
}
...
export function RadioIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="M4.9 19.1C1 15.2 1 8.8 4.9 4.9M7.8 16.2c-2.3-2.3-2.3-6.1 0-8.4M16.2 7.8c2.3 2.3 2.3 6.1 0 8.4M19.1 4.9C23 8.8 23 15.2 19.1 19.1" />
...
export function SparklesIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="M9.94 2.06 8 6l-3.94 1.06L6 11l-1.06 3.94L8 14l3.94 1.06L11 18l1.06-3.94L16 13l3.94-1.06L18 8l1.06-3.94L16 6l-3.94-1.06L11 2l-1.06 3.94Z" />
      <path d="M20 2v4M22 4h-4M4 18v2M5 19H3" />
    </svg>
  );
}

/** StarIcon - filled by default; use `className="fill-none stroke-current"` for outline. */
...
export function TikTokIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.34-6.34V8.99a8.24 8.24 0 0 0 4.77 1.5V7.04a4.85 4.85 0 0 1-1-.35z" />
    </svg>
  );
}
