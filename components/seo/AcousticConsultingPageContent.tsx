...
import {
  HOME_STUDIO_FAQS,
  HOME_STUDIO_HERO_SUBTITLE,
  HOME_STUDIO_PAGE_TITLE,
  HOME_STUDIO_PLANS,
  HOME_STUDIO_PROCESS_STEPS,
  HOME_STUDIO_SERVICE_SECTIONS,
  HOME_STUDIO_STUDIO_TYPES,
...
const faqItems = HOME_STUDIO_FAQS.map((faq) => ({
  id: faq.id,
    ...
    <div className="bg-background">
      ...
      >
        <div className="mx-auto max-w-[72rem] px-4 sm:px-6 lg:px-8">
          ...
          <ol className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {HOME_STUDIO_PROCESS_STEPS.map((step) => (
              <li
                key={step.step}
                className="rounded-2xl border border-border bg-background p-6"
              >
      ...
      <section className="mx-auto max-w-[72rem] px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
        ...
        <p className="mt-8 text-sm leading-relaxed text-muted-foreground">
          ...
          רזומה עשיר, אחסוך לכם טעויות של זמן וכסף שלוואי - כאלה שהייתי חוסך
          בעצמי בתחילת הדרך.
        </p>
        <p className="mt-3 text-sm font-medium text-foreground">
          לפעמים עצה אחת יכולה לחסוך לכם ים של כסף - ואני יודע שזה שווה את זה.
        </p>
      ...
      <section className="border-t border-border bg-background py-14 sm:py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
            אספר לכם בשפה שלכם בדיוק מה שאתם מסוגלים גם לשמוע. האפשרות להיעזר
            בי זו הבחירה שלכם בלבד - אחרי ששמעתם את ההדרכות והרעיונות ואתם
            בטוחים שאני יכול לפתור עבורכם כל סוגיה בנושא מוזיקה, סאונד וציוד.
          </p>
          ...
          <div className="mt-8 rounded-2xl border border-border bg-surface p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <Link
                  href="/blog/studio-guide"
                  className="text-brand-red hover:underline"
                >
                  המדריך המלא להקמת אולפן הקלטות
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="text-brand-red hover:underline"
                >
                  רוצים להקליט אצלנו במודיעין במקום?
                </Link>
              </li>
              <li>
                <Link
