...
const AI_SERVICES = [
  ...
  {
    id: "volume_balance_full",
    name: "איזון ווליומין",
    icon: <VolumeIcon />,
    exVat: getExVat("volume_balance_full"),
    billingType: "one-time" as const,
    deliverables: [
      "איזון עוצמות קול אחיד לאורך הקטע",
      "נורמליזציה לפלטפורמות (יוטיוב, ספוטיפיי)",
      "קובץ WAV או MP3 מוכן",
    ],
    note: "לקטע עד 5 דקות",
    whatsappText: "שלום, יש לי הקלטה עם ווליום לא אחיד - אשמח לאיזון ווליומין.",
    ctaHref: "/online/vocal-fix/volume-balance",
    ctaLabel: "פרטים נוספים",
  },
  {
    id: "noise_removal_segment",
    name: "ניקוי רעשים",
    icon: <NoiseMuteIcon />,
  ...
  {
    id: "eq_freq_fix",
    name: "תיקון תדרים ו-EQ",
    icon: <EqIcon />,
    exVat: getExVat("eq_freq_fix"),
    billingType: "one-time" as const,
    deliverables: [
      "איזון תדרים: הסרת צרימה ועמימות",
      "EQ מותאם לפלטפורמה (פודקאסט, יוטיוב)",
      "קובץ WAV או MP3 מוכן",
    ],
    note: "לקטע עד 5 דקות",
    whatsappText: "שלום, הסאונד שלי לא טוב - אשמח לתיקון תדרים ו-EQ.",
