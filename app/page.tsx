...
const HOME_FAQ_SCHEMA = buildFaqSchema([
  ...
  },
  {
    ...
    answer: "הקלטת ברכה פשוטה: מוכן תוך 24-48 שעות. שיר מלא עם עריכה: עד 48 שעות. פודקאסט ואירועים: לפי היקף הפרויקט. לוח זמנים ברור נקבע בשיחה הראשונה.",
  },
  {
    question: "לאיזה אזורים אתם מגיעים?",
    answer: "האולפן במודיעין. לאירועים מגיעים לפתח תקווה, שוהם, ירושלים ולכל הארץ. הקלטות בירושלים בתיאום מראש. תוספת נסיעות מחוץ לאזור המרכז.",
  },
  {
    question: "איך משלמים?",
  ...
  },
  {
    ...
    answer: "כן. שולחים קובץ בוואטסאפ, במייל או ב-Drive - ומחזירים קובץ מטופל תוך שעות. תיקון זיופים, ניקוי רעשים, מיקס ומאסטרינג - הכל מרחוק. פרטים בשירותי עריכה מקוונים.",
  },
]);
