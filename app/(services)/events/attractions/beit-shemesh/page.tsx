...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    "עשן כבד, זיקוקים קרים, בועות וקונפטי לחתונות ואירועים בבית שמש. מפעיל מקצועי, תיאום מנהל האולם - 20-25 דקות ממודיעין. הצעה תוך שעה.",
  slug: "events/attractions/beit-shemesh",
  keywords: [
    "אטרקציות לאירועים בבית שמש",
    "מכונת עשן לחתונה בית שמש",
    "זיקוקים קרים בית שמש",
    "תותח קונפטי בית שמש",
    "אפקטים לחתונה בית שמש",
    "מכונת בועות לאירוע בית שמש",
  ],
});
...
const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    question: "איך מתאמים עם מנהל האולם בבית שמש?",
    answer:
      "אנחנו מתקשרים ישירות עם מנהל האולם לפני האירוע - בודקים גובה תקרה, אוורור ואישורי בטיחות. אתם לא מתעסקים עם הלוגיסטיקה.",
  },
  {
    id: "travel",
    question: "יש תוספת הגעה לבית שמש?",
    answer:
      "בית שמש נמצאת 20-25 דקות ממודיעין דרך כביש 38. נציין את עלות ההגעה במפורש בהצעת המחיר לפני אישור - בלי הפתעות.",
  },
  {
    id: "setup-time",
  ...
  {
    id: "which-attraction",
    question: "איזו אטרקציה מתאימה לאולמות בית שמש?",
    answer:
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "אטרקציות לאירועים בבית שמש",
  ...
  provider: {
    ...
    areaServed: ["בית שמש", "מודיעין-מכבים-רעות", "המרכז"],
  },
  url: `${SITE_URL}/events/attractions/beit-shemesh`,
};

const waHref = buildWhatsAppHref({
  text: "שלום, מעוניין/ת באטרקציות לאירוע בבית שמש. אשמח לשמוע על אפשרויות ומחירים.",
  utm_source: "website",
  utm_campaign: "attractions_beit_shemesh",
});

export default function AttractionsBeitShemeshPage() {
  return (
    <>
      <script
      ...
      <article className="bg-background">
          ...
          <Container variant="wide" className="py-14 sm:py-18 lg:py-20">
            <nav aria-label="ניווט ארגוני" className="mb-5">
              <ol className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <li aria-hidden>/</li>
                <li className="font-medium text-foreground" aria-current="page">בית שמש</li>
              </ol>
            </nav>
            ...
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              עשן כבד, זיקוקים קרים, בועות וקונפטי - מגיעים לאולמות בית שמש ישירות ממודיעין.
              תיאום מול מנהל האולם, התקנה מוקדמת ופעלת בלי שתרגישו כלום.
            </p>
            <ContextualIntroParagraph pathname="/events/attractions/beit-shemesh" className="mt-4" />
            <p className="mt-3 text-sm font-semibold text-brand-red">
              20-25 דקות מבית שמש - בלי דמי הגעה מופרזים
            </p>
        ...
        <div className="mx-auto max-w-[72rem] space-y-16 px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
          <ServiceHubLinks
            ...
            heading="האטרקציות שמגיעות לבית שמש"
            subheading="משרתים חתונות, בר ובת מצווה, אירועי חברה ומסיבות פרטיות באזור בית שמש."
          ...
          >
            <h2 id="service-area-heading" className="font-serif text-xl font-semibold text-foreground sm:text-2xl">
              אולמות שאנחנו מכירים בבית שמש
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              עובדים עם אולמות גדולים וקטנים בכל אזור בית שמש - מהמרכז ועד לשכונות החדשות. לפני
              האירוע, מתאמים ישירות עם מנהל המקום ובודקים גובה תקרה, אוורור ואישורים.
            </p>
            <ul className="mt-5 flex flex-wrap gap-2">
              {["בית שמש מרכז", "רמת בית שמש", "נווה שאנן", "גני הזית", "מטה יהודה"].map((area) => (
                <li
                  key={area}
          ...
          <FAQAccordion
            items={FAQ_ITEMS}
            title="שאלות על אטרקציות בבית שמש"
          ...
          <ServiceHubLinks
            ...
            subheading="שירותים נוספים לאירועים בבית שמש ובמרכז."
            links={[
              {
              ...
              },
              {
                ...
                title: "צילום חתונות",
                description: "צלם חתונות עם ניסיון באירועים באזור בית שמש.",
              },
            ]}
            columns={4}
          />
