...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    "עשן כבד, זיקוקים קרים, בועות וקונפטי לחתונות ואירועים בשוהם. מפעיל מקצועי, תיאום מנהל האולם - 10-15 דקות ממודיעין. הצעה תוך שעה.",
  slug: "events/attractions/shoham",
  keywords: [
    "אטרקציות לאירועים בשוהם",
    "מכונת עשן לחתונה שוהם",
    "זיקוקים קרים שוהם",
    "תותח קונפטי שוהם",
    "אפקטים לחתונה שוהם",
    "מכונת בועות לאירוע שוהם",
  ],
});
...
const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    question: "איך מתאמים עם מנהל האולם בשוהם?",
    answer:
      "אנחנו מתקשרים ישירות עם מנהל האולם לפני האירוע - בודקים גובה תקרה, אוורור ואישורי בטיחות. אתם לא מתעסקים עם הלוגיסטיקה.",
  },
  {
    id: "travel",
    question: "יש תוספת הגעה לשוהם?",
    answer:
      "שוהם נמצאת 10-15 דקות ממודיעין דרך כביש 443. המרחק קצר ובדרך כלל אין תוספת הגעה משמעותית - נציין הכל בהצעת המחיר מראש.",
  },
  {
    id: "setup-time",
  ...
  {
    id: "which-attraction",
    question: "איזו אטרקציה מתאימה לאולמות בשוהם?",
    answer:
...
const jsonLd = {
  ...
  url: `${SITE_URL}/events/attractions/shoham`,
};

const waHref = buildWhatsAppHref({
  text: "שלום, מעוניין/ת באטרקציות לאירוע בשוהם. אשמח לשמוע על אפשרויות ומחירים.",
  utm_source: "website",
  utm_campaign: "attractions_shoham",
});

export default function AttractionsShohamPage() {
  return (
    <>
      <script
      ...
      <article className="bg-background">
          ...
          <Container variant="wide" className="py-14 sm:py-18 lg:py-20">
            <nav aria-label="ניווט ארגוני" className="mb-5">
              <ol className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <li aria-hidden>/</li>
                <li className="font-medium text-foreground" aria-current="page">שוהם</li>
              </ol>
            </nav>
            ...
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              עשן כבד, זיקוקים קרים, בועות וקונפטי - מגיעים לאולמות שוהם ישירות ממודיעין.
              תיאום מול מנהל האולם, התקנה מוקדמת ופעלת בלי שתרגישו כלום.
            </p>
            <ContextualIntroParagraph pathname="/events/attractions/shoham" className="mt-4" />
            <p className="mt-3 text-sm font-semibold text-brand-red">
              10-15 דקות משוהם - בלי דמי הגעה מופרזים
            </p>
        ...
        <div className="mx-auto max-w-[72rem] space-y-16 px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
          <ServiceHubLinks
            ...
            heading="האטרקציות שמגיעות לשוהם"
            subheading="משרתים חתונות, בר ובת מצווה, אירועי חברה ומסיבות פרטיות באזור שוהם."
          ...
          >
            <h2 id="service-area-heading" className="font-serif text-xl font-semibold text-foreground sm:text-2xl">
              אולמות שאנחנו מכירים בשוהם
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              עובדים עם אולמות וגני אירועים באזור שוהם והסביבה. לפני
              האירוע, מתאמים ישירות עם מנהל המקום ובודקים גובה תקרה, אוורור ואישורים.
            </p>
            <ul className="mt-5 flex flex-wrap gap-2">
              {["שוהם מרכז", "כפר דניאל", "בן שמן", "חדיד", "גמזו"].map((area) => (
                <li
                  key={area}
          ...
          <ServiceHubLinks
            ...
            subheading="שירותים נוספים לאירועים בשוהם ובמרכז."
            links={[
              {
                href: "/dj-events/cities/shoham",
                title: "DJ לאירועים בשוהם",
                description: "תקליטן מנוסה לאולמות בשוהם - ממודיעין.",
              },
              {
              ...
              },
              {
                ...
                title: "צילום אירועים",
                description: "צלם אירועים עם ניסיון באזור שוהם והמרכז.",
              },
            ]}
            columns={4}
          />
