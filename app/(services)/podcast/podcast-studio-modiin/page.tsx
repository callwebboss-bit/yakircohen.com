...
export const metadata = constructMetadata({
  title: "הקלטת פודקאסט במודיעין | קריינות אנושית - מקום תוך 24 שעות",
  description:
    "אולפן לפודקאסט וקריינות אנושית במודיעין. ציוד מקצועי, ליווי טכני מלא וקביעת מקום תוך 24 שעות. ללא AI-רובוטי - קול נקי, אנושי ומרשים. מירושלים, המרכז ומודיעין.",
