...
export const metadata: Metadata = constructMetadata({
  title: "אולפן פודקאסט קרוב לבית שמש - 20 דקות מבית שמש",
  description:
    "אולפן פודקאסט מקצועי 20 דקות מבית שמש - חדרי הקלטה עם ציוד מקצועי, חניה פנויה ועריכה מלאה. מתאים לפרק ראשון ולסדרות פודקאסט עסקיות.",
  slug: "podcast/beit-shemesh",
  keywords: [
    "אולפן פודקאסט בית שמש",
    "פודקאסט קרוב לבית שמש",
    "הקלטת פודקאסט בית שמש",
    "אולפן הקלטות פודקאסט מודיעין",
    "הקלטת פודקאסט עסקי בית שמש",
  ],
});
...
const FAQ_ITEMS: FAQItem[] = [
  {
    id: "distance",
    question: "כמה זמן נסיעה מבית שמש?",
    answer:
      "כ-20 דקות בנסיעה רגילה דרך כביש 38 + כביש 1. יש חניה פנויה ממש ליד האולפן - בלי להסתובב.",
  },
  {
    id: "first-time",
...
const FEATURES = [
  {
    title: "20 דקות מבית שמש",
    desc: "דרך כביש 38 + כביש 1 לכיוון מודיעין. חניה פנויה ליד האולפן.",
  },
  {
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "אולפן פודקאסט קרוב לבית שמש",
  description:
    "הקלטת פודקאסט מקצועי 20 דקות מבית שמש. ציוד מלא, עריכה, מסירה לפרסום.",
  provider: {
    "@type": "LocalBusiness",
    name: "יקיר כהן הפקות",
  ...
  url: `${SITE_URL}/podcast/beit-shemesh`,
};

const waHref = buildWhatsAppHref({
  text: "שלום, מעוניין/ת להקליט פודקאסט באולפן - מגיע/ה מבית שמש. אשמח לשמוע על אפשרויות ותאריכים פנויים.",
  utm_source: "website",
  utm_campaign: "podcast_beit_shemesh",
});

export default function PodcastBeitShemeshPage() {
  return (
    <>
      <script
      ...
      <article className="bg-background">
        ...
        <header className="border-b border-border bg-background">
          <Container variant="wide" className="py-14 sm:py-18 lg:py-20">
            ...
            <h1 className="mt-4 font-serif text-3xl font-semibold text-foreground sm:text-4xl lg:text-5xl">
              אולפן פודקאסט 20 דקות מבית שמש
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              מגיעים ממודיעין - 20 דקות מבית שמש דרך כביש 38 + כביש 1 עם חניה פנויה.
        ...
        <div className="mx-auto max-w-[72rem] space-y-16 px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              כביש 38 צפונה עד כביש 1, ומשם לכיוון מודיעין. נסיעה של כ-20 דקות
              ברוב שעות היום. חניה פנויה ברחוב ליד האולפן - לא צריך לחפש.
            </p>
          ...
          <FAQAccordion
            items={FAQ_ITEMS}
            title="שאלות על הקלטת פודקאסט מבית שמש"
