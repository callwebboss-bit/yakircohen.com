...
export const metadata: Metadata = constructMetadata({
  title: "אולפן פודקאסט קרוב לשוהם - 10 דקות משוהם",
  description:
    "אולפן פודקאסט מקצועי 10 דקות משוהם - חדרי הקלטה עם ציוד מקצועי, חניה פנויה ועריכה מלאה. מתאים לפרק ראשון ולסדרות פודקאסט עסקיות.",
  slug: "podcast/shoham",
  keywords: [
    "אולפן פודקאסט שוהם",
    "פודקאסט קרוב לשוהם",
    "הקלטת פודקאסט שוהם",
    "אולפן הקלטות פודקאסט במודיעין",
    "הקלטת פודקאסט עסקי שוהם",
  ],
});
...
const FAQ_ITEMS: FAQItem[] = [
  {
    id: "distance",
    question: "כמה זמן נסיעה משוהם?",
    answer:
      "כ-10-15 דקות בנסיעה רגילה דרך כביש 443. יש חניה פנויה ממש ליד האולפן - בלי להסתובב.",
  },
  {
    id: "first-time",
...
const FEATURES = [
  {
    title: "10 דקות משוהם",
    desc: "דרך כביש 443 לכיוון מודיעין. חניה פנויה ליד האולפן.",
  },
  {
...
const waHref = buildWhatsAppHref({
  text: "שלום, מעוניין/ת להקליט פודקאסט באולפן - מגיע/ה משוהם. אשמח לשמוע על אפשרויות ותאריכים פנויים.",
  utm_source: "website",
  utm_campaign: "podcast_shoham",
});

export default function PodcastShohamPage() {
  return (
    <>
      <script
      ...
      <article className="bg-background">
        ...
        <header className="border-b border-border bg-background">
          <Container variant="wide" className="py-14 sm:py-18 lg:py-20">
            ...
            <h1 className="mt-4 font-serif text-3xl font-semibold text-foreground sm:text-4xl lg:text-5xl">
              אולפן פודקאסט 10 דקות משוהם
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              מגיעים ממודיעין - 10 דקות משוהם דרך כביש 443 עם חניה פנויה.
        ...
        <div className="mx-auto max-w-[72rem] space-y-16 px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              כביש 443 דרומה לכיוון מודיעין. נסיעה של 10-15 דקות ברוב שעות היום.
          ...
          <FAQAccordion
            items={FAQ_ITEMS}
            title="שאלות על הקלטת פודקאסט משוהם"
          ...
          <nav aria-label="שירותים קשורים">
            <ul className="flex flex-wrap gap-3 text-sm">
              {[
                ...
                { label: "אולפן הקלטות שוהם", href: "/studio/studio-shoham" },
